...
<img src="./assets/duck.gif" width="200" height="200" alt="Pinterest GIF">
...
--- <img src="./assets/cats.gif" width="200" height="100" position="center" alt="Pinterest GIF"> ---

### Featured Projects

| Project | Description | Stack |
|---------|-------------|-------|
| [**Glocal**](https://github.com/prawnfairy/Glocal) | Stock analysis tool for traders with real-time market data and insights | JavaScript |
...
|---|---|
| **Programming** | Python, C++, PHP, JavaScript, HTML, CSS, SQL |
| **AI & ML** | Machine learning, deep learning, data modelling |
| **Databases** | MySQL, phpMyAdmin |
| **Cloud & DevOps** | AWS, Microsoft Azure AI, Docker |
| **Networking & Systems** | Cisco Packet Tracer, Wireshark, 5G & IoT systems |
